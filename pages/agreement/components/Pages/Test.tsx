  ...
  const generatePDF = () => {
    ...
    const documentDefinition = {
      content: [
        ...
        {
          text: 'By and amongst/ समझौते के पक्ष: -',
          style: { font: 'Hindi' }
        },
        ...
        {
          text: [
            { text: 'WHEREAS', style: 'heading', bold: true },
            { text: '\n अतएव:', style: 'heading', font: 'Hindi' }
          ],
          margin: [0, 20, 0, 0]
        },
        {
        ...
        {
          text: [
            { text: 'IDENTIFICATION CLAUSE', style: 'heading', bold: true },
            { text: '\nपहचान खंड', style: 'heading', font: 'Hindi' }
          ],
          margin: [0, 20, 0, 0]
        },
        {
        ...
        },
        {
          stack: [
            ...
            },
            {
              ...
              style: { fontSize: 12, marginBottom: 10, font: 'Hindi' }
            },
            {
              text: [
                {
