...
const PDFGenerator = ({ data }) => {
  ...
  const generatePDF = () => {
    ...
    const documentDefinition = {
      content: [
        {
          text: 'ADVANCE KYC AGREEMENT',
          alignment: 'center',
          style: 'englishText'
        },
        { text: 'by and between', alignment: 'center', style: 'englishText' },
        {
          text: 'RAMAERA INDUSTRIES LIMITED',
          alignment: 'center',
          style: 'englishText'
        },
        { text: 'and', alignment: 'center', style: 'englishText' },
        {
        ...
        },
        {
          text: [
            ...
            { text: "'Agreement'", style: 'englishText' },
            ' is made on ',
            {
            ...
            " ('Execution date') at ",
            { text: 'Noida, Uttar Pradesh.', bold: true }
          ]
        },
        {
...

        {
          text: [
            ...
            { text: '“Party” ', style: 'bold' },
            'and collectively as the ',
            { text: '“Parties”.', style: 'bold' }
          ],
          margin: [0, 0, 0, 40]
        },
        { text: 'Definition: ', style: 'heading' },
        {
          ol: [
            ...
            },
            {
              text: [
                '• ',
                { text: '“Board of Directors” ', style: 'bold' },
        ...
        },
        {
          text: [
            ...
            {
              text: " बिजनेस का अर्थ है फास्ट मूविंग कंज्यूमर गुड्स ('एफएमसीजी') जैसे मसाले, नूडल्स, टूथपेस्ट, खाद्य तेल, आटा और इसी तरह के अन्य व्यवसाय का निर्माण, वितरण और बिक्री, जिसे कंपनी समय-समय पर कर सकती है;",
              style: 'indent'
            }
          ]
        },
        {
          text: [
            ...
            {
              text: ' बिजनेस डे  का अर्थ है रविवार और जिस दिन भारत में वाणिज्यिक बैंक लागू कानून या किसी सरकारी प्राधिकरण की कार्रवाई के तहत बंद रहते हैं; को छोड़कर कोई भी दिन;',
              style: 'indent'
            }
          ]
        },
        {
          text: [
            { text: '• ', style: 'bullet' },
            { text: '“Companies Act”', style: 'bold' },
            ' means the Companies Act, 2013, as amended from time to time;',
            {
              text: '  कंपनी एक्ट  का अर्थ कंपनी अधिनियम, 2013 है, जो समय-समय पर संशोधित होता है;',
              style: 'indent'
            }
          ]
        },
        {
          text: [
            ...
            {
              text: '  कपनी का अर्थ है रमेरा इंडस्ट्रीज लिमिटेड जिसका पंजीकृत कार्यालय एच-150, सेक्टर - 63, नोएडा, गौतम बुद्ध नगर, उत्तर प्रदेश - 201301 में है।',
              style: 'indent'
            }
          ]
        },
        {
          text: [
            { text: '• ', style: 'bullet' },
            { text: '“Directors”', style: 'bold' },
            ' mean the directors on the Board and “Director” has the corresponding meaning;',
            {
              text: "  डायरेक्टर्स का अर्थ बोर्ड के निदेशकों से हैं और जिसका अर्थ 'निदेशक' के अनुरूप है;",
              style: 'indent'
            }
          ]
        },
        {
          text: [
            { text: '• ', style: 'bullet' },
            { text: '“Equity Shares”', style: 'bold' },
            ' means the equity shares of the Company having a Face value of Rs 10/-;',
            {
              text: '  इक्विटी शेयर का अर्थ है कंपनी के हिस्सेदारी शेयर जिनका अंकित मूल्य 10/- रुपये (केवल दस रुपये) है;',
              style: 'indent'
            }
          ]
        },
        {
          text: [
            { text: '• ', style: 'bullet' },
            { text: '“Financial Statements”', style: 'bold' },
            ' means the audited financial statements of the Company.',
            {
              text: '  फाइनेंसियल स्टेटमेंट  का अर्थ है कंपनी के लेखापरीक्षित वित्तीय विवरण।',
              style: 'indent'
            }
          ]
        },
        {
          text: [
            { text: '• ', style: 'bullet' },
            { text: '“Governmental Authority”', style: 'bold' },
            ...
            {
              text: '  गवर्नमेंटल अथॉरिटी  का अर्थ है कोई भी (अ) राष्ट्रीय, राज्य, स्थानीय, नगरपालिका, विदेशी या अन्य सरकारी, (ब) किसी भी प्रकृति का सरकारी या अर्ध-सरकारी प्राधिकरण (किसी भी सरकारी एजेंसी, शाखा, विभाग या अन्य संस्था सहित और कोई भी अदालत या अन्य न्यायाधिकरण) या (स) किसी भी प्रशासनिक, कार्यकारी, न्यायिक, अर्ध-न्यायिक, विधायी, पुलिस, प्रशासनिक, नियामक या कर लगाने वाले प्राधिकरण या किसी भी प्रकृति की शक्ति का प्रयोग या प्रयोग करने का हकदार निकाय;',
              style: 'indent'
            }
          ]
        },
        {
          text: [
            ...
            {
              text: '  केवाईसी  का संक्षिप्त नाम नो योर कस्टमर है, जिसका तात्पर्य शेयर ग्राहक द्वारा अपनी कानूनी पहचान साबित करने के लिए कंपनी को प्रदान की गई जानकारी से है।',
              style: 'indent'
            }
          ]
        },
        ...
        },
        {
          text: [
            { text: '• ', style: 'bullet' },
            { text: '“ADVANCE KYC AMOUNT”', style: 'bold' },
            ' means the Subscription amount subscribed by the subscriber.',
            {
              text: '  अग्रिम केवाईसी राशि  का अर्थ ग्राहक द्वारा ली गई सदस्यता राशि है।',
              style: 'indent'
            }
          ]
        },
        {
          text: [
            ...
            {
              text: '  सब्सक्राइबर सह शुद्ध लाभ मार्जिन पार्टनर  का अर्थ एक व्यक्तिगत व्यक्ति या कोई अन्य व्यक्ति है जिसने रुपये की राशि की सदस्यता ली है। रामाएरा इंडस्ट्रीज लिमिटेड के इक्विटी शेयर में 1,00,000 या अधिक (केवल एक लाख रुपये या अधिक)। (इसके बाद इसे "कंपनी" के रूप में संदर्भित किया जाएगा)।',
              style: 'indent'
            }
          ]
        },
        {
          text: [
            ...
            {
              text: '  लॉ  का अर्थ है कोई भी संघीय, राज्य, स्थानीय, नगरपालिका, विदेशी, अंतर्राष्ट्रीय, बहुराष्ट्रीय, संविधान, कानून, क़ानून, संधि, नियम, विनियमन, अध्यादेश, कोड, मामला कानून या सामान्य कानून का सिद्धांत और इसमें कोई भी प्रत्यायोजित कानून शामिल है या एक सरकारी प्राधिकरण का निर्देश;',
              style: 'indent'
            }
          ]
        },
        {
          text: [
            ...
            {
              text: '  लायबिलिटी  में देयताएं, ऋण या किसी भी प्रकृति के अन्य दायित्व शामिल हैं, चाहे ज्ञात या अज्ञात, पूर्ण, उपार्जित, आकस्मिक या अन्यथा, देय या देय हो या अन्यथा, और कंपनी के वित्तीय विवरणों में परिलक्षित होने की आवश्यकता हो या नहीं ;',
              style: 'indent'
            }
          ]
        },
        {
          text: [
            { text: '• ', style: 'bullet' },
            { text: '“Memorandum”', style: 'bold' },
            ' means the memorandum of association of the Company;',
            {
              text: '  मेमोरेंडम  का अर्थ कंपनी के सहयोग का ज्ञापन है;',
              style: 'indent'
            }
          ]
        },
        {
          text: [
            { text: '• ', style: 'bullet' },
            { text: '“Ordinary Course of Business”', style: 'bold' },
        ...
        },
        {
          text: [
            ...
            {
              text: '  प्रॉफिट  का अर्थ कंपनी के राजस्व से सभी प्रकार के खर्चों में कटौती के बाद कंपनी का लाभ है, लेकिन कंपनी के राजस्व से (कंपनी की ओर से किसी भी प्राधिकरण को भुगतान किए गए किसी भी समायोजन या किसी भी प्रकार के करों सहित) तक सीमित नहीं है।',
              style: 'indent'
            }
          ]
        },
        {
          text: [
            { text: '• ', style: 'bullet' },
            { text: '“Net profit Sharing Ratio”', style: 'bold' },
            ...
            {
              text: '  नेट प्रॉफिट शेयरिंग रेशियो  का अर्थ उक्त समझौते में निर्धारित नियमों और शर्तों के अनुसार निवेशक के बीच वितरित कंपनी का लाभ है।',
              style: 'indent'
            }
          ]
        },
        {
          text: [
            ...
            {
              text: '  आर ओ सी  का अर्थ संबंधित कंपनी रजिस्ट्रार है;',
              style: 'indent'
            }
          ]
        },
        ...
        },
        {
          text: [
            { text: '• ', style: 'bullet' },
            { text: '“Shareholder”', style: 'bold' },
            ' means any Person who owns the Securities;',
            {
              text: '  शेयर होल्डर  का अर्थ किसी भी व्यक्ति से है जो प्रतिभूतियों का मालिक है;',
              style: 'indent'
            }
          ]
        },
        {
          text: [
            ...
            {
              text: '  शेयर कैपिटल  का अर्थ है पूरी तरह से भुगतान किया हुआ और और कंपनी की तरफ से जारी इक्विटी शेयर पूंजी;',
              style: 'indent'
            }
          ]
        },
        {
          text: [
            ...
            {
              text: "  सब्सक्राइबर- सब्सक्राइबर एक इकाई ('इकाई') है और ऐसी इकाई की ओर से हस्ताक्षर करने के लिए अधिकृत व्यक्ति एक विधिवत नियुक्त एजेंट या इकाई का प्रतिनिधि है और इसे प्रमाणित करता है।",
              style: 'indent'
            }
          ]
        },
        {
          text: [
            { text: '• ', style: 'bullet' },
            { text: '“Project Unit “', style: 'bold' },
            'Means a unit set up by the Company in any place in India for the Manufacturing of Fast-Moving Consumer Goods (“FMCG”)',
            {
              text: "  प्रोजेक्ट यूनिट - का अर्थ है कंपनी द्वारा भारत में किसी भी स्थान पर फास्ट मूविंग कंज्यूमर गुड्स ('एफएमसीजी') के निर्माण के लिए स्थापित की गई इकाई। का अर्थ है सभी इकाइयां जहां एफएमसीजी उत्पादों का निर्माण कंपनी द्वारा किया जाना है।",
              style: 'indent'
            }
          ]
        },
          ...
          ol: [
            {
              text: [
                { text: '• ', style: 'bullet' },
                {
                  text: 'The Subscriber desires to subscribe to the Equity Shares of the Company for which the subscriber undertakes to provide complete information under this Advance KYC agreement.\nसब्सक्राइबर कंपनी के इक्विटी शेयरों की सदस्यता लेना चाहता है जिसके लिए सब्सक्राइबर इस एडवांस केवाईसी समझौते के तहत पूरी जानकारी प्रदान करने का वचन देता है।',
                  style: 'text'
                }
              ]
            },
        ...
        {
          text: [
            { text: 'NOW, THEREFORE,', style: 'heading' },
            { text: 'अब, इसलिए,', style: 'heading' }
          ]
        },
        {
          ol: [
        ...
        {
          text: [
            { text: 'IDENTIFICATION CLAUSE', style: 'heading' },
            { text: '\nपहचान खंड', style: 'heading' }
          ]
        },
        {
          ol: [
            {
              text: [
                { text: 'Name of the Subscriber (As per PAN and Adhaar): ' },
                {
                  text: data?.getAgreementData?.agreementFieldData['2'],
                  style: 'italic'
                },
                {
                  text: '; [In case of sole proprietorship]: i) Aadhar OR Enrolment No (ii) Pan card OR Form 60 (Mandatory) “Officially Valid Documents” i) Passport ii) Voter’s Identity Card iii) Driving License iv) NREGA Job Card: NA ; * With any one document as proof of business/ activity in the name of the proprietary firm. [In case of case of companies] : (i) Certificate of Incorporation (ii) Memorandum & Articles of Association (iii) Permanent Account Number of the company. (iv) Resolution of the Board of Directors to open an account and identification of those who have authority to operate the account: Name of the Company: NA CIN: NA'
                }
              ]
            },
            {
          ...
          ol: [
            ...
            },
            {
              text: [
                { text: 'b) ', style: 'text' },
                {
                  text: 'The Subscriber shall get the profit share on a yearly basis.\n',
                  style: 'text'
                },
                {
                  text: 'सदस्य वार्षिक आधार पर लाभ साझाकरण प्राप्त करेगा।\n',
                  style: 'text'
                }
              ]
            },
            {
              text: [
                { text: 'c) ', style: 'text' },
                {
                  text: 'The Subscriber shall be entitled to receive the share of profit after the adjustment of all operational expenses and liabilities of the company. It is clarified that all expenses, debts, liabilities, borrowings, advances etc., shall be adjusted before the calculation of Net Profit and sharing to the subscriber.\n',
                  style: 'text'
                },
                {
                  text: 'सदस्य को कंपनी के सभी परिचालन खर्च और दायित्वों के समायोजन के बाद लाभ का हिस्सा प्राप्त करने का अधिकार होगा। स्पष्ट किया जाता है कि शुद्ध लाभ और इसके वितरण से पहले सभी खर्च, ऋण, दायित्व, उधार, आगामी आदि का समायोजन किया जाएगा।\n',
                  style: 'text'
                }
              ]
            }
        ...
        {
          text: 'IN WITNESS WHEREOF, the undersigned has hereby executed this Advance KYC Agreement as of the date set forth below.\n'
        },
        {
