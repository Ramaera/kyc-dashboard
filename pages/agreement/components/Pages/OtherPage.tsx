      ...
      <View style={{ paddingHorizontal: 100 }}>
        <div style={{ fontSize: 14, height: 'auto' }}>
          ...
          <p style={{ marginBottom: 20 }}>
            ...
            <p style={{ fontWeight: 'bold' }}>“Agreement”</p> is made on{' '}
          ...
          <p style={{ marginBottom: 30 }}>
            ...
            Subscriber) having PAN
            {data.getAgreementData.agreementFieldData['3']} S/O{' '}
            {data.getAgreementData.agreementFieldData['4']} and having
            Residential Address at{' '}
            {data.getAgreementData.agreementFieldData['5']}, hereinafter
            referred to as the “Subscriber” (which expression shall, unless
            repugnant to the context or meaning thereof, be deemed to means and
            include its successors, nominee and permitted assigns), Of{' '}
          ...
          <p>
            ...
            (जो अभिव्यक्ति, जब तक कि इस संदर्भ या इसके अर्थ के प्रतिकूल न हो,
            इसका मतलब यही माना जाएगा और इसके उत्तराधिकारी, नामांकित और अनुमत
            असाइनर्स शामिल होंगे ) <strong>समझौते के लिए पहली पार्टी</strong> के
            रूप में संदर्भित किया गया है,
          </p>
          <strong>And/ और</strong>
          <p style={{ marginBottom: 20 }}>
            Ramaera Industries Limited a Company incorporated under the
            ...
            <br /> The Company and the Subscriber shall individually be referred
            to as <strong>“Party” </strong>and collectively as the{' '}
          ...
          <p style={{ marginBottom: 80 }}>
            ...
            <strong>" रामाएरा /कंपनी" </strong> (जो अभिव्यक्ति, जब तक कि संदर्भ
            या उसके अर्थ के प्रतिकूल न हो, इसका अर्थ समझा जाएगा और इसमें इसके
            उत्तराधिकारी और अनुमत समनुदेशिती शामिल हैं) ,को{' '}
            <strong>समझौते के लिए दूसरी पार्टी</strong>के रूप में संदर्भित किया
            गया हैI <br />
            कंपनी और सब्सक्राइबर को व्यक्तिगत रूप से <strong>
              {' '}
              "पार्टी"
            </strong>{' '}
            और सामूहिक रूप से
          ...
          <ol>
            <li style={{ marginBottom: 30 }}>
              <strong>“Articles”</strong> means the Articles of Association of
              the Company; <br />
              "आर्टिकल" का अर्थ है कंपनी के संस्था के अंतर्नियम;
            </li>
            <li style={{ marginBottom: 30 }}>
              <strong>“Agreement”</strong> means a mutual contract entered
              between the Company and the Subscriber upon agreed terms and
              conditions.
              <br />
            ...
            <li style={{ marginBottom: 30 }}>
              <strong>“Board of Directors”</strong>means in the context of
              company that a group of directors in the organization.
              <br />
              बोर्ड ऑफ़ डायरेक्टर्स - कंपनी के संबंध में बोर्ड ऑफ़ डायरेक्टर्स का
              अर्थ है कंपनी के डायरेक्टर्स का सामूहिक निकाय।
            </li>
            <li style={{ marginBottom: 30 }}>
              <strong>“Business”</strong> means manufacture, distribution and
              sale of Fast-Moving Consumer Goods (“FMCG”) such as Spices,
              Noodles, Toothpaste, Edible Oil, Flour and such other similar
              business as the Company may undertake from time to time;
              <br />
            ...
            <li style={{ marginBottom: 30, marginTop: 60 }}>
              <strong>“Business Day”</strong> means any day other than a Sunday
              or any days on which commercial banks in India are closed under
              the applicable Law or action of any Governmental Authority;;{' '}
              <br />
            ...
            <li style={{ marginBottom: 30 }}>
              <strong>“Company”</strong> means the Ramaera Industries Limited
              having its registered office at H-150, Sector – 63, Noida, Gautam
              Buddha Nagar, Uttar Pradesh – 201301. <br />
            ...
            <li style={{ marginBottom: 30 }}>
              <strong>“Financial Statements”</strong> means the audited
            ...
            <li style={{ marginBottom: 30 }}>
              ...
              entity and any court or other tribunal) or (c) body exercising or
              entitled to exercise, any administrative, executive, judicial,
              quasi-judicial, legislative, police, administrative, regulatory or
            ...
            <li style={{ marginBottom: 30 }}>
              <strong>“KYC”</strong> the abbreviation stands for Know your
              Customer, which is implies on the information provided to the
              company by the share subscriber to prove his legal self. <br />
            ...
            <li style={{ marginBottom: 30 }}>
              <strong>“ADVANCE KYC AMOUNT”</strong> means the Subscription
              amount subscribed by the subscriber. ; <br />
              "अग्रिम केवाईसी राशि" का अर्थ ग्राहक द्वारा ली गई सदस्यता राशि है।
            </li>
            <li style={{ marginBottom: 30 }}>
              <strong>“Subscriber cum net profit margin partner”</strong> means
              an individual person or any other person who has subscribed an
              amount of Rs. 1,00,000 or more (Rupees One Lakh or more Only) in
              the Equity share of Ramaera Industries Limited. (Hereinafter
              referred to as “the Company”). ; <br />
            ...
            <li style={{ marginBottom: 30 }}>
              ...
              treaty, rule, regulation, ordinance, code, case law, or principle
              of common law and includes any delegated legislation or a
              directive of a Governmental Authority; <br />
            ...
            <li style={{ marginBottom: 30 }}>
              ...
              accrued, contingent or otherwise, due or to become due or
            ...
            <li style={{ marginBottom: 30 }}>
              <strong>“Memorandum”</strong> means the memorandum of association
              of the Company; <br />
              "मेमोरेंडम" का अर्थ कंपनी के सहयोग का ज्ञापन है;
            </li>
            <li style={{ marginBottom: 30 }}>
              <strong>“Ordinary Course of Business”</strong> in relation to any
              action, transaction, or activity of the Company means the carrying
              out or undertaking of such action, transaction, or activity in
              accordance with past practices of the Company in accordance with
              the Business Plan and in each case only to the extent consistent
            ...
            <li style={{ marginBottom: 30 }}>
              <strong>“Profit”</strong> means the net profit of the Company
              after deducting all types of expenses but not limited to
              (including any adjustment or any type of taxes paid to any
              authority on behalf of the Company) from revenue of the Company{' '}
              <br />
              "प्रॉफिट" का अर्थ कंपनी के राजस्व से सभी प्रकार के खर्चों में
              कटौती के बाद कंपनी का लाभ है, लेकिन कंपनी के राजस्व से (कंपनी की
              ओर से किसी भी प्राधिकरण को भुगतान किए गए किसी भी समायोजन या किसी
              भी प्रकार के करों सहित) तक सीमित नहीं है।
            </li>
            <li style={{ marginBottom: 30 }}>
              <strong>“Net profit Sharing Ratio”</strong> means the net profit
              of the Company distributed among the Subscriber as per terms and
            ...
            <li style={{ marginBottom: 30 }}>
              ...
              shares, debentures, bonds, loans, warrants, options, or other
              similar instruments or securities of the Company that are
              convertible into or exercisable or exchangeable for or which carry
              a right to subscribe to or purchase, Equity Shares or any
              instrument or certificate representing a legal or beneficial
              ownership interest in Equity Shares, including global depository
              receipts or American depository receipts; <br />
              "सिक्योरिटीज" का अर्थ इक्विटी शेयर, वरीयता शेयर, डिबेंचर, बॉन्ड,
              ऋण, वारंट, विकल्प या कंपनी के अन्य समान उपकरण या प्रतिभूतियां हैं
              जो परिवर्तनीय हैं या प्रयोग करने योग्य या विनिमय योग्य हैं या जो
              सदस्यता लेने या खरीदने का अधिकार रखते हैं , इक्विटी शेयर या
              वैश्विक डिपॉजिटरी रसीदें या अमेरिकी डिपॉजिटरी रसीदें सहित इक्विटी
              शेयरों में कानूनी या लाभकारी स्वामित्व हित का प्रतिनिधित्व करने
              वाला कोई उपकरण या प्रमाणपत्र;
            </li>
            <li style={{ marginBottom: 30 }}>
              <strong>“Shareholder”</strong> means any Person who owns the
              Securities;
              <br />
              "शेयर होल्डर" का अर्थ किसी भी व्यक्ति से है जो प्रतिभूतियों का
              मालिक है;
            </li>
            <li style={{ marginBottom: 30 }}>
              <strong>“Share Capital”</strong>means the issued and fully paid-up
              Equity Share capital of the Company, on a Fully Diluted Basis;{' '}
              <br />
              "शेयर कैपिटल" का अर्थ है पूरी तरह से भुगतान किया हुआ और और कंपनी
              की तरफ से जारी इक्विटी शेयर पूंजी;
            </li>
            <li style={{ marginBottom: 30 }}>
              <strong>“Subscriber”</strong>The Subscriber is any individual
              person or an entity and a person authorized to sign on behalf of
              such Entity or is a duly appointed agent or representative of the
              Entity and hereby warrants.
              <br />
              सब्सक्राइबर- सब्सक्राइबर एक इकाई ("इकाई") है और ऐसी इकाई की ओर से
              हस्ताक्षर करने के लिए अधिकृत व्यक्ति एक विधिवत नियुक्त एजेंट या
              इकाई का प्रतिनिधि है और इसे प्रमाणित करता है।)
            </li>
            <li style={{ marginBottom: 30 }}>
              <strong>“Project Unit “</strong>Means a unit set up by the Company
              in any place in India for the Manufacturing of Fast-Moving
              Consumer Goods (“FMCG”).
              <br />
              प्रोजेक्ट यूनिट - का अर्थ है कंपनी द्वारा भारत में किसी भी स्थान
              पर फास्ट मूविंग कंज्यूमर गुड्स ("एफएमसीजी") के निर्माण के लिए
              स्थापित की गई इकाई। का अर्थ है सभी इकाइयां जहां एफएमसीजी उत्पादों
              का निर्माण कंपनी द्वारा किया जाना है।
            </li>
          </ol>
          <strong>
            WHEREAS
          ...
          <ol>
            <li>
              ...
              लिए सब्सक्राइबर इस एडवांस केवाईसी समझौते के तहत पूरी जानकारी
            ...
            <li>
              ...
              कानूनों, नियमों और विनियमों के तहत अपने दायित्वों के अनुपालन में
              है।
            </li>
          </ol>
          <p>
            ...
            <br />
            निवेशकों द्वारा निवेशक सदस्यता शेयरों की सदस्यता से संबंधित नियमों
            और शर्तों को निर्धारित करने के लिए पार्टियां इस समझौते को निष्पादित
            करने के लिए सहमत हुई हैं।
          </p>
          <p>
            ...
            receipt and sufficiency of which is acknowledged by the Parties, the
          ...
          <ol type="A">
            <li>
              ...
              or reorganized for the purpose of making this subscription <br />
            ...
            <li>
              ...
              <br />
              कंपनी के संबंध में दर्ज और निष्पादित किए गए सभी दस्तावेज उनकी
              शर्तों के अनुसार लागू करने योग्य इकाई के वैध और अनिवार्य दस्तावेज
              हैं।
            </li>
            <li>
          ...
          <ol>
            ...
            <li>
              ...
              ; [In case of sole proprietorship]: i) Aadhar OR Enrolment No (ii)
              Pan card OR Form 60 (Mandatory) “Officially Valid Documents” i)
              Passport ii) Voter’s Identity Card iii) Driving License iv) NREGA
              Job Card: NA ; * With any one document as proof of business/
              activity in the name of the proprietary firm. [In case of case of
              companies] : (i) Certificate of Incorporation (ii) Memorandum &
              Articles of Association (iii) Permanent Account Number of the
              company. (iv) Resolution of the Board of Directors to open an
              account and identification of those who have authority to operate
              the account: Name of the Company: NA CIN: NA
              <br />
            ...
            <li style={{ marginTop: 100 }}>
              ...
              कीमत पर।{data.getAgreementData.agreementFieldData['10']} (आंकड़ों
              में)
          ...
          <ol type="a">
            <li>
              ...
              स्वीकृति के अधीन है। रामाएरा इस सदस्यता को स्वीकार या अस्वीकार
              करने के लिए, अपने एकमात्र और पूर्ण विवेकाधिकार में, पूर्ण या आंशिक
              रूप से अधिकार सुरक्षित रखता है और कंपनी द्वारा लिखित रूप में
              स्वीकार किए जाने तक सदस्यता बाध्यकारी नहीं होगी।)
            </li>
            <li>
              The Subscriber acknowledges that, in order to subscribe for
              Shares, the Subscriber must hereby deliver to the Company:
              सब्सक्राइबर स्वीकार करता है कि, शेयरों की सदस्यता लेने के लिए
              उन्हें निम्नलिखित दस्तावेजों को कंपनी में उपलब्ध करवानी पड़ेगी
              <br />
            </li>
            <li>
            ...
            <li>
              ...
              <br />
              शेयरों की सदस्यता लेने के लिए शेयर्स के आवेदन में भुगतान किए गए
              राशि की रसीद।
            </li>
            <li>
            ...
            <li>
              ...
              उल्लिखित निर्धारित राशि का एक चेक, ट्रेड ड्राफ्ट या मीडिया देय
              बिल, कंपनी के पक्ष में देय है; इस समझौता पत्र के साथ संलग्न किया
              जाएगा।
            </li>
          </ol>
          <strong>
          ...
          <ol type="a">
            ...
            <li>
              ...
              परिणाम/ या लाभ के उपलब्धि या प्राप्ति केलिए किसी भी प्रकार का
              गारंटी या वारंटी प्रस्तुत नहीं किया गया है।
            </li>
            <li>
              ...
              सब्सक्राइबर, सब्सक्राइबर बनाने वाले, कंपनी में अपने निवेश को
              अधिकृत करने वाले और/या पूर्वगामी की संतुष्टि का प्रमाण देने वाले
              सभी प्रासंगिक दस्तावेजों की सही, पूर्ण और वर्तमान प्रतियां प्रदान
              करेगा।
            </li>
            <li>
              ...
              <br />
              इस समझौते में प्रवेश करने से पहले. सब्सक्राइबर ने निर्धारित किया
              है कि कंपनी की सदस्यता एक उपयुक्त निर्णय है, कंपनी के नियमों और
              शर्तों के अनुसार, अनुपात के मुकाबले शुद्ध लाभ साझाकरण के आधार पर।
              ग्राहक द्वारा स्वीकृत योजना. निवेश के आधार पर रिटर्न का विवरण नीचे
              दिया गया है।
            </li>
          </ol>
          <strong>
          ...
          <ol type="a">
            <li>
              ...
              <ol type="I">
                ...
                <li>
                  The 30% net profit is subject to the company being profitable
                  in the fiscal year in case the company fails to achieve the
                  target set forth by the company/board, then also board
                  reserves the right to the net profit sharing as decided in the
                  agreement.
                  <br />
                  30% लाभ कंपनी के वित्तीय वर्ष में लाभदायक होने के अधीन है, यदि
                  कंपनी/बोर्ड द्वारा निर्धारित लक्ष्य को प्राप्त करने में विफल
                  रहती है, तो बोर्ड शुद्ध लाभ साझा करने का अधिकार सुरक्षित रखता
                  है। समझौते में तय हुआ.
                </li>
              </ol>
            </li>
            <li>
          ...
          <p style={{ marginBottom: 30 }}>
            यह समझौता राज्य - उत्तर प्रदेश में पूरी तरह से किए गए अनुबंधों पर
            लागू कानूनों के अनुसार निष्पादित और शासित होगा।
          </p>
          <p style={{ marginBottom: 30 }}>
            ...
            Arbitration of the Indian Council of Arbitration and Arbitration and
            Conciliation Act, 1996 and the award made in pursuance thereof shall
            be binding on the parties.", the seat for arbitration will be
            Kanpur, Uttar Pradesh. Both the parties further agree to appoint
            sole arbitrator as mutually agreed between the parties.
          </p>
          <p style={{ marginBottom: 30 }}>
          ...
          <p>
            ...
            <br /> यह एग्रीमेंट एक या अधिक समकक्षों में निष्पादित किया जा सकता
            है।
          </p>
          <strong>
            PERSONS BOUND
          ...
          <p>
            ...
            अधिनियम का पालन करने के बाद शेयरों के हस्तांतरण/बायबैक के माध्यम से
            इस तरह के समझौते को समाप्त करने या रद्द करने का अधिकार सुरक्षित है।
          </p>
          <strong>
          ...
          <p>
            ...
            <br />
            यह अनुबंध विषय वस्तु के संबंध में कंपनी और सब्सक्राइबर के बीच
            संपूर्ण अनुबंध का गठन करता है।
          </p>
          <p>
            Force Majeure: Ramaera shall not be liable for any failure in
            performance of the obligation under this Agreement due to cause
            beyond that Ramaera's reasonable control (including and not limited
            to any pandemic, fire, strike, act or order of public authority, and
            other acts of God) during the pendency of such event.
            <br />
            अप्रत्याशितता- रामाएरा इस समझौते के तहत दायित्व के प्रदर्शन में किसी
            भी प्रकार की विफलता, जो कि रामाएरा के उचित नियंत्रण से परे है,
            (जैसे- किसी भी महामारी, आग, हड़ताल, अधिनियम या सार्वजनिक प्राधिकरण
            के आदेश, और भगवान के अन्य कृत्यों तक सीमित) के लिए उत्तरदायी नहीं
            होगा।
          </p>
          <strong>
          ...
          <p>
            ...
            स्वीकार करता है कि उसने समझौते के नियमों और शर्तों को प्राप्त कर
            लिया है और उसे समझ लिया है और वह उसमें निहित सभी नियमों और शर्तों से
            सहमत है।
          </p>
          <p>
            IN WITNESS WHEREOF, the undersigned has hereby executed this Advance
            KYC Agreement as of the date set forth below. <br />
            इसके साक्ष्य में, अधोहस्ताक्षरी ने नीचे दी गई तिथि के अनुसार इस
            समझौते को निष्पादित किया है।
          </p>
          ...
          <p>
            ...
            एतत्द्वारा घोषणा करता हूं कि मैंने इस समझौते के नियमों और शर्तों को
            पढ़ और समझ लिया है। मैं रामेरा इंडस्ट्रीज लिमिटेड और इस समझौते के
